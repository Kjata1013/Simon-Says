...
#define CHOICE_RED	(1 << 0) // B00000001  or  0x01
#define CHOICE_GREEN	(1 << 1) // B00000010  or  0x02
#define CHOICE_BLUE	(1 << 2) // B00000100  or  0x04
#define CHOICE_YELLOW	(1 << 3) // B00001000  or  0x08
